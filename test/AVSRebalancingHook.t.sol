...
// contract TestAVSRebalancingHook is Test, Deployers {
...
//         emit log(
//             "Deploying TransparentUpgradeableProxy for MevAuctionTaskManager"
//         );
...
//         );
//         emit log(
//             "TransparentUpgradeableProxy for MevAuctionTaskManager deployed"
//         );
...
//         require(
//             uint160(hookAddress) & HookMiner.FLAG_MASK == flags,
//             "Invalid hook address generated"
//         );
...
//             "Deployed hook address does not match mined address"
//         );
...
//         emit log_named_uint(
//             "Pool Manager Token Balance",
//             token.balanceOf(address(poolManager))
//         );
//         emit log_named_uint(
//             "Regular Address Token Balance",
//             token.balanceOf(regularAddress)
//         );
//         emit log_named_uint(
//             "Token Allowance for Swap Router by Regular Address",
//             token.allowance(regularAddress, address(swapRouter))
//         );
//         emit log_named_uint(
//             "Token Allowance for Pool Manager by this contract",
//             token.allowance(address(this), address(poolManager))
//         );
//     }
...
//         emit log_named_uint(
//             "Manager ETH balance before add liquidity",
//             address(manager).balance
//         );
//         emit log_named_uint(
//             "Manager TOKEN balance before add liquidity",
...
//         emit log_named_uint(
//             "Manager ETH balance after add liquidity",
//             address(manager).balance
//         );
//         emit log_named_uint(
//             "Manager TOKEN balance after add liquidity",
//             token.balanceOf(address(manager))
//         );
//         vm.stopPrank();
...
//         emit log_named_uint(
//             "Outside address ETH balance before swap",
//             outsideAddress.balance
//         );
//         emit log_named_uint(
//             "Outside address TOKEN balance before swap",
//             token.balanceOf(outsideAddress)
//         );
...
//         emit log_named_uint(
//             "Outside address ETH balance after swap",
//             outsideAddress.balance
//         );
//         emit log_named_uint(
//             "Outside address TOKEN balance after swap",
//             token.balanceOf(outsideAddress)
//         );
//         vm.stopPrank();
//     }
...
//         vm.prank(highestBidder);
//         hook.executeSwap{value: highestBid, gas: 3000000}(taskId);

//         // Verify the swap was completed
//         MevAuctionHook.SwapDetails memory completedSwap = hook.getSwapDetails(
//             taskId
//         );
